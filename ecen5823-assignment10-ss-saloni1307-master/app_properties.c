...
/// Unique ID (e.g. UUID or GUID) for the product
/// this application is built for (uint8_t[16])
...
KEEP_SYMBOL const ApplicationProperties_t sl_app_properties = {
  ...
  /// struct. Must equal @ref APPLICATION_PROPERTIES_MAGIC
  .magic = APPLICATION_PROPERTIES_MAGIC,
  /// Version number of this struct
  .structVersion = APPLICATION_PROPERTIES_VERSION,
  /// Type of signature this application is signed with
  .signatureType = APPLICATION_SIGNATURE_NONE,
  /// Location of the signature. Typically a pointer
