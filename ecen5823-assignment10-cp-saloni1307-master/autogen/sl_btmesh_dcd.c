...
const uint8_t __mesh_dcd[] = {
  ...
  /* Main */
    ...
    0x06, /* Number of SIG Models = 6 */
    0x00, /* Number of Vendor Models = 0 */
    /* SIG Models */
      U16TOA(0x0000), /* Configuration Server */
      U16TOA(0x0002), /* Health Server */
      U16TOA(0x1001), /* Generic On/Off Client */
      U16TOA(0x1302), /* Light Lightness Client */
      U16TOA(0x1305), /* Light CTL Client */
      U16TOA(0x1205), /* Scene Client */
};
