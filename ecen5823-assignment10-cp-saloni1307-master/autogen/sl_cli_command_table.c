...
static const sl_cli_command_info_t cli_cmd_factory_full_reset = \
  SL_CLI_COMMAND(factory_reset_from_cli,
                 "Triggers a factory reset that erase all NVM keys",
                  "",
                 {SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_factory_node_reset = \
  SL_CLI_COMMAND(node_reset_from_cli,
                 "Triggers a node reset that erase all mesh stack data",
                  "",
                 {SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd__info = \
  SL_CLI_COMMAND(info,
                 "Prints info about BT address and mesh UUID",
                  "",
                 {SL_CLI_ARG_END, });
...
static const sl_cli_command_entry_t factory_group_table[] = {
  { "full_reset", &cli_cmd_factory_full_reset, false },
  { "r", &cli_cmd_factory_full_reset, true },
  { "node_reset", &cli_cmd_factory_node_reset, false },
  { "n", &cli_cmd_factory_node_reset, true },
  { NULL, NULL, false },
};
static const sl_cli_command_info_t cli_cmd_grp_factory = \
  SL_CLI_COMMAND_GROUP(factory_group_table, "Factory functions (e.g. factory reset).");
...
const sl_cli_command_entry_t sl_cli_default_command_table[] = {
  ...
  { "factory", &cli_cmd_grp_factory, false },
  { "f", &cli_cmd_grp_factory, true },
  { NULL, NULL, false },
};
